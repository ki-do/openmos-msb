...
public class OpcUaDiscoveryMilo {
	...
	void createRegisterServerData(String discoveryEndpoint) throws Exception {
      ...
      // EndpointDescription[] endpoints = UaTcpStackClient.getEndpoints("opc.tcp://fmoranda-pc.introsys.lan:4840").get();
            ...
            OpcUaClientConfig clientConfig = OpcUaClientConfig.builder().setApplicationName(LocalizedText.english("opc-uaMSBclient"+serverName))//
                    .setApplicationUri("urn:opcuaclient"+serverName)//
                    .setCertificate(cert)//
                    .setKeyPair(keyPair)//
    ...
    protected String getApplicationUri() {
        return "urn:MSBGeneric:opcua:server";
    }

    protected String getProductUri() {
        return "urn:MSBGeneric:opcua:sdk";
    }

    protected LocalizedText getApplicationName() {
        return LocalizedText.english("MSBGeneric opc-ua server");
    }
